...
public class DivinBootsTickEventProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if (entity instanceof LivingEntity _entity && !_entity.level.isClientSide())
			_entity.addEffect(new MobEffectInstance(MobEffects.LUCK, 60, 2, false, false));
		if (entity instanceof LivingEntity _entity && !_entity.level.isClientSide())
		...
		(itemstack).enchant(Enchantments.FALL_PROTECTION, 20);
