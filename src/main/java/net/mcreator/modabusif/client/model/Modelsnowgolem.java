package net.mcreator.modabusif.client.model;
...
public class Modelsnowgolem<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modsupertool", "modelsnowgolem"), "main");
	public final ModelPart piece2;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition arm1 = piece1.addOrReplaceChild("arm1", CubeListBuilder.create().texOffs(32, 0).addBox(1.0F, -4.0F, -1.0F, 12.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, 0.0F, 0.0F, 0.7854F));
		PartDefinition arm2 = piece1.addOrReplaceChild("arm2", CubeListBuilder.create().texOffs(32, 0).addBox(1.0F, 2.0F, -1.0F, 12.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, 0.0F, 0.0F, 2.3562F));
