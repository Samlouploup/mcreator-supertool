...
public class EpeeDivineItem extends SwordItem {
	public EpeeDivineItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("une lame si puissante qu'elle pourait couper en deux excalibur"));
	}

	@Override
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		super.onCraftedBy(itemstack, world, entity);
		EpeeDivineQuandLobjetEstFabriquefonduProcedure.execute(itemstack);
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			EpeeDivineLosqueLepeeEstDansLaMainProcedure.execute(entity);
	}
}
