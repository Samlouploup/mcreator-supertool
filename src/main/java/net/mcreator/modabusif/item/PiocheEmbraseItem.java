...
import net.mcreator.modabusif.procedures.PiocheembraseprocedureProcedure;
...
public class PiocheEmbraseItem extends PickaxeItem {
	public PiocheEmbraseItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
		...
		}, 1, -3.4f, new Item.Properties().tab(ModsupertoolModTabs.TAB_ARMURES_OUTILS_SUPER_TOOLS));
	}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		PiocheembraseprocedureProcedure.execute(entity);
		return retval;
	}
