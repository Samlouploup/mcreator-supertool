...
import net.mcreator.modabusif.procedures.PiocheSupremeToolInHandTickProcedure;
...
public class PiocheSupremeItem extends PickaxeItem {
	public PiocheSupremeItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("peut servir d'arme"));
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			PiocheSupremeToolInHandTickProcedure.execute(entity);
	}
}
