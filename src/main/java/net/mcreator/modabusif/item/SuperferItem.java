...
import net.mcreator.modabusif.procedures.SuperferHelmetTickEventProcedure;
import net.mcreator.modabusif.init.ModsupertoolModTabs;

import java.util.List;

public abstract class SuperferItem extends ArmorItem {
	public SuperferItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends SuperferItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "modsupertool:textures/models/armor/fer_layer_1.png";
		}

		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			SuperferHelmetTickEventProcedure.execute(entity);
		}
	}

	public static class Chestplate extends SuperferItem {
		public Chestplate() {
	...
	public static class Leggings extends SuperferItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "modsupertool:textures/models/armor/fer_layer_2.png";
		}
	...
	public static class Boots extends SuperferItem {
		public Boots() {
