...
import net.mcreator.modabusif.procedures.FlameParfaiteItemInHandTickProcedure;
import net.mcreator.modabusif.init.ModsupertoolModTabs;

import java.util.List;

public class FlameParfaiteItem extends Item {
	public FlameParfaiteItem() {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			FlameParfaiteItemInHandTickProcedure.execute(entity);
	}
}
