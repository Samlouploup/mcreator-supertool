...
import net.mcreator.modabusif.procedures.PiocheEnEarthenergieToolInHandTickProcedure;
import net.mcreator.modabusif.init.ModsupertoolModTabs;

import java.util.List;

public class PiocheEnEarthenergieItem extends PickaxeItem {
	public PiocheEnEarthenergieItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("breaking power:2"));
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			PiocheEnEarthenergieToolInHandTickProcedure.execute(entity);
	}
}
