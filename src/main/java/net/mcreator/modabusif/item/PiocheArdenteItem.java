...
import net.mcreator.modabusif.procedures.PiocheArdenteLivingEntityIsHitWithToolProcedure;
import net.mcreator.modabusif.init.ModsupertoolModTabs;

import java.util.List;

public class PiocheArdenteItem extends PickaxeItem {
	public PiocheArdenteItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		PiocheArdenteLivingEntityIsHitWithToolProcedure.execute(entity);
		return retval;
	}
