...
import net.mcreator.modabusif.procedures.PiocheDuPharaonToolInHandTickProcedure;
import net.mcreator.modabusif.procedures.PiocheDuPharaonQuandLobjetEstFabriquefonduProcedure;
import net.mcreator.modabusif.init.ModsupertoolModTabs;

import java.util.List;

public class PiocheDuPharaonItem extends PickaxeItem {
	public PiocheDuPharaonItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("breaking power:3"));
		list.add(Component.literal("enchant\u00E9"));
		list.add(Component.literal("donne c\u00E9l\u00E9rit\u00E9 2"));
		list.add(Component.literal("mine en 3X3 si vous n'\u00EAtes pas accroupi"));
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		PiocheDuPharaonQuandLobjetEstFabriquefonduProcedure.execute(itemstack);
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			PiocheDuPharaonToolInHandTickProcedure.execute(entity);
	}
